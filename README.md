...
After all panes are ready, each pane displays its role. Claude, Codex, and Codex2 receive concise startup role prompts in their own panes; Gemini uses a static Chinese startup warning plus a short pane title/badge (`Gemini 前端/UI`) instead of a model-generated prompt, avoiding a long “thinking” response.
